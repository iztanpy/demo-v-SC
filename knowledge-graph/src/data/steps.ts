...
export const STEPS: StepCopy[] = [
  {
    ...
    body: 'The Data team searches the knowledge graph for past incidents matching the BFP-3A vibration signature. Fleet precedents light up. The Evaluator ranks them into diagnosis candidates.',
  ...
  },
  {
    ...
    body: 'A diagnosis is selected — NDE bearing race spalling, 78%. The Graph Writer records it as a new node linked to the symptom; the Schema & Provenance Guardian validates the write while the SOP & Safety Validator confirms it is safe to proceed.',
    activeAgents: ['data-writer', 'data-guardian', 'eval-sop'],
    handoffs: [
      { from: 'data', to: 'kg', label: 'write: initial Dx' },
      { from: 'kg', to: 'data', label: 'schema ✓' },
    ],
    parallel: true,
    live: 'Graph Writer recording the initial diagnosis — Guardian and SOP & Safety validating in parallel.',
  },
  {
    n: 3,
  ...
  },
  {
    ...
    body: 'The initial diagnosis is NOT deleted. The Graph Writer tags it incorrect and draws a corrected-by edge to the bent-shaft node — preserved as a future learning point, validated by the Guardian and the SOP & Safety check.',
    activeAgents: ['data-writer', 'data-guardian', 'eval-sop'],
  ...
  },
  {
    ...
    activeAgents: ['data-writer', 'data-guardian'],
