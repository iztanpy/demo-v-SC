...
const RAW: RawDoc[] = [
  ...
  { id: 'dx', incident: 'INC-0537', asset: 'BFP-3A', kind: 'diagnosis', label: 'Initial diagnosis', agent: 'Diagnosis Parser', source: 'Faye Sit · ops override', outcome: 'exception', slot: 1, parse: 1200, extract: 800, field: 'AI recommendation overriden', value: 'AI recommended Shaft misalignment · 85% → Faye selected NDE bearing race spalling · 78%', rationale: 'Specific bearing and temperature conditions' },
  { id: 'w3-onsite', incident: 'INC-0537', asset: 'BFP-3A', kind: 'workflow-trace', label: 'Onsite workflow', agent: 'Workflow Tracer', source: 'L. Lim · onsite · Honeywell Experion DCS', outcome: 'exception', slot: 2, parse: 900, extract: 600, field: 'Onsite verification', value: 'Safety + root-cause checklist · SOP-BFP-VIBR-001', steps: [{ label: 'Safety measures followed', done: 5, total: 5 }, { label: 'Root cause isolation completed', done: 2, total: 5 }] },
