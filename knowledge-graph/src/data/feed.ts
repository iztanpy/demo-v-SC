...
const RAW: RawDoc[] = [
  ...
  { id: 'd6', incident: 'INC-0537', asset: 'BFP-3A', kind: 'call', label: 'Call transcript', agent: 'Call Agent', source: 'Dr. A. Ismail ↔ L. Lim', outcome: 'exception', slot: 4, parse: 1500, extract: 1000, field: 'Revised Diagnosis', value: 'Pump casing fatigue crack · same mode as Northgate-CCGT-2 BFP (2023)', extras: [{ k: 'Troubleshooting', v: 'Liquid penetrant would confirm · ~60 mm from discharge weld' }], recommendation: { label: 'Shutdown required — can’t run with a propagating casing crack', detail: 'via Call Agent · Dr. A. Ismail ↔ L. Lim' } },
