...
const RAW: RawDoc[] = [
  ...
  // Onsite workflow → Call transcript → Initial findings. ──
  { id: 'w3', incident: 'INC-0537', asset: 'BFP-3A', kind: 'workflow-trace', label: 'Test path', agent: 'Workflow Tracer', source: 'Bently Nevada 3500 / Honeywell Experion DCS', outcome: 'exception', root: true, slot: 0, parse: 1500, extract: 1000, field: 'Test path', value: 'Bent shaft (AI) → Bearing race spalling (Ops) → Casing crack (Actual)', journey: [{ label: 'Bent shaft', tag: 'AI recommended', tone: 'ai' }, { label: 'Bearing race spalling', tag: 'Ops selection', tone: 'ops' }, { label: 'Casing crack', tag: 'Actual', tone: 'actual' }] },
